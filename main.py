...
app = FastAPI(title="GPT System API", version="0.1.0", debug=True)  # Инициализация FastAPI
...
@app.get('/info')
def read_root():
    return {'Project 2023': '🤖 GPT System - "Создание нейро-консультанта для ответов на вопросы клиентов" [г. Москва, 2023 г.]'}
